...
public class DroneControlService
    ...
    public static final String TAG = "DroneControlService";

    // These constants should match the enum defined in jni/API/common.h
    ...
    public void onCreate() {
        super.onCreate();
        droneVersion = DroneConfig.EDroneVersion.UNKNOWN;
        ...
        Thread workerThread = new Thread(this, "Drone Worker Thread");
     ...
     *
     * @param value power - value between -1 and 1.
     */
    ...
    public DroneConfig.EDroneVersion getDroneVersion() {
        if (droneVersion == DroneConfig.EDroneVersion.UNKNOWN) {
            DroneConfig.EDroneVersion version = getDroneConfig().getDroneVersion();

            if (version == DroneConfig.EDroneVersion.UNKNOWN) {
    ...
    public void setProgressiveCommandEnabled(boolean b) {
        droneProxy.setCommandFlag(DroneProxy.DroneProgressiveCommandFlag.ARDRONE_PROGRESSIVE_CMD_ENABLE.ordinal(), b);
    }


    public void setProgressiveCommandCombinedYawEnabled(boolean b) {
        droneProxy.setCommandFlag(DroneProxy.DroneProgressiveCommandFlag.ARDRONE_PROGRESSIVE_CMD_COMBINED_YAW_ACTIVE.ordinal(), b);
    }
