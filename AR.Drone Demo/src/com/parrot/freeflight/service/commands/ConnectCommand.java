...
public class ConnectCommand extends DroneServiceCommand
    ...
    public void execute() {
        ...
        DroneProxy.EVideoRecorderCapability recorderCapability = DeviceCapabilitiesUtils.getMaxSupportedVideoRes();

        if (recorderCapability == DroneProxy.EVideoRecorderCapability.NOT_SUPPORTED) {
            // Giving user a chance to record the video
            recorderCapability = DroneProxy.EVideoRecorderCapability.VIDEO_360P;
        }
