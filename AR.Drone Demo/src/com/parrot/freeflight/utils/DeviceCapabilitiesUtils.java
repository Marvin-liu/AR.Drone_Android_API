...
public class DeviceCapabilitiesUtils {
     ...
     */
    static public DroneProxy.EVideoRecorderCapability getMaxSupportedVideoRes() {
        DroneProxy.EVideoRecorderCapability videoResolution = DroneProxy.EVideoRecorderCapability.VIDEO_720P;
        ...
        if (profile != null) {
            if (profile.videoFrameHeight >= 720) {
                videoResolution = DroneProxy.EVideoRecorderCapability.VIDEO_720P;
            } else if (profile.videoFrameHeight >= 360) {
                videoResolution = DroneProxy.EVideoRecorderCapability.VIDEO_360P;
            } else if (profile.videoFrameHeight < 360) {
                videoResolution = DroneProxy.EVideoRecorderCapability.NOT_SUPPORTED;
            }
        }
